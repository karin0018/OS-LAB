...
<img src="https://github.com/karin0018/OS-LAB/Lab2_New/实验报告/image-20200503124322592.png" alt="image-20200503124322592" style="zoom:80%;" />
...
<img src="https://github.com/karin0018/OS-LAB/Lab2_New/实验报告\image-20200503125408537.png" alt="image-20200503125408537" style="zoom:80%;" />
...
<img src="https://github.com/karin0018/OS-LAB/Lab2_New/实验报告\image-20200503130037290.png" alt="image-20200503130037290" style="zoom:80%;" />

type == 'r’ : 子进程写入，关闭读端，打开写端，将程序的标准输出重定向到写端文件。

type == 'w’ : 父进程写入，子进程 read ，子进程关闭写端，打开读端文件，并把程序的标准输入重定向到读端文件。 

![image-20200503132811700](https://github.com/karin0018/OS-LAB/Lab2_New/实验报告\image-20200503132811700.png)
